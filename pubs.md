...
<div id="tag-filter-container" style="margin-bottom: 30px;">
  ...
  <div id="tag-buttons" style="margin-bottom: 15px;">
    <button class="tag-filter-btn" data-tag="AI" id="tag_AI" style="margin: 5px; padding: 8px 15px; border: 1px solid #B8D4E8; background-color: #B8D4E8; border-radius: 4px; cursor: pointer; font-size: 14px; color: #333;">AI</button>
    ...
    <button class="tag-filter-btn" data-tag="BCI" id="tag_BCI" style="margin: 5px; padding: 8px 15px; border: 1px solid #B8D4E8; background-color: #B8D4E8; border-radius: 4px; cursor: pointer; font-size: 14px; color: #333;">BCI</button>
    <button class="tag-filter-btn" data-tag="Fabrication" id="tag_Fabrication" style="margin: 5px; padding: 8px 15px; border: 1px solid #B8D4E8; background-color: #B8D4E8; border-radius: 4px; cursor: pointer; font-size: 14px; color: #333;">Fabrication</button>
    <button class="tag-filter-btn" data-tag="Graphics" id="tag_Graphics" style="margin: 5px; padding: 8px 15px; border: 1px solid #C8E6D4; background-color: #C8E6D4; border-radius: 4px; cursor: pointer; font-size: 14px; color: #333;">Graphics</button>
