...
<div id="tag-filter-container" style="margin-bottom: 30px;">
  ...
  <div id="tag-buttons" style="margin-bottom: 15px;">
    ...
    <button class="tag-filter-btn" data-tag="XR" id="tag_XR" style="margin: 5px; padding: 8px 15px; border: 1px solid #B8D4E8; background-color: #B8D4E8; border-radius: 4px; cursor: pointer; font-size: 14px; color: #333;">XR</button>
